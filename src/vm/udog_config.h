#ifndef udog_config_h
#define udog_config_h

// This header contains macros and defines used across the entire UDog
// implementation. In particular, it contains "configuration" defines that
// control how UDog works. Some of these are only used while hacking on
// debugging UDog itself.
//
// This header is *not* intended to be included by code outside of UDog itself.

#include "limits.h"

// UDog pervasively uses the C99 integer types (uint16_t, etc.) along with some
...
// UDOG_BITPLATFORM_XX designates whether the platform is 32 or 64 bits
...
// Check windows
	...
	#if defined(_WIN64)
		#define UDOG_BITPLATFORM_64
	#else
		#define UDOG_BITPLATFORM_32
	#endif
#endif
...
// Defaults to on.
#ifndef UDOG_BYTECODE
	#define UDOG_BYTECODE 1
#endif

// If true, the compiled exe or library will contain the required
// code to debug code
// Defaults to on.
#ifndef UDOG_DEBUGGER
	#define UDOG_DEBUGGER 1
#endif
...
// Defaults to on.
#ifndef UDOG_USE_LIB_IO
	#define UDOG_USE_LIB_IO 1
#endif

// If true, uses the default file loader
// Defaults to on.
#ifndef UDOG_USE_DEFAULT_FILE_LOADER
	#define UDOG_USE_DEFAULT_FILE_LOADER 1
#endif

// If true, loads the "Regex" class in the standard library.
// Defaults to on.
#ifndef UDOG_USE_REGEX
	#define UDOG_USE_REGEX 1
#endif

// Use the VM's allocator to allocate an object of [type].
#define ALLOCATE(vm, type) \
    ((type*)udogReallocate(vm, NULL, 0, sizeof(type)))
...
// If true, then UDog will use a NaN-tagged double for its core value
...
//
// Defaults to on.
#ifndef UDOG_NAN_TAGGING
	#define UDOG_NAN_TAGGING 1
#endif
...
// These flags are useful for debugging and hacking on UDog itself. They are not
