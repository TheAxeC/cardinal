...
// Does nothing, it is a dummy opcode
OPCODE(EMPTY)
...
// methods. This instruction is faster than the more general OPCODE(LOAD_FIELD
// instruction.
...
// more general OPCODE(LOAD_FIELD) instruction.
...
// always be preceded by a `OPCODE(RETURN`) so is never actually executed.
OPCODE(END)

//Call breakpoint) this happens after every line of code
OPCODE(BREAK)